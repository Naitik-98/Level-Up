...
namespace Level_Up.Forms
{
    public partial class Library : Form
    {
        ...
        private void labelTop_Click_1(object sender, EventArgs e)
        {
        ...
        private void labelTop_Click_2(object sender, EventArgs e)
        {

        }

        private void panelLeft_Paint_2(object sender, PaintEventArgs e)
        {

        }

        private void panelMain_Paint_2(object sender, PaintEventArgs e)
        {
